...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.Задачи") Тогда
		// Заполнение шапки
...
Процедура ОбработкаПроведения(Отказ, Режим)
	// регистр УчетТрудозатрат Приход
	Движения.УчетТрудозатрат.Записывать = Истина;
	Движение = Движения.УчетТрудозатрат.Добавить();
	...
	Движение.Трудоемкость = ОценкаТрудозатрат;
	Движение.Продолжительность = Работы.Итог("Трудозатраты");

	Движения.ФактическиеЧасыПоЗадачам.Записывать = Истина;
	Движение = Движения.ФактическиеЧасыПоЗадачам.Добавить();
	Движение.Период = Дата;
	Движение.Клиент = Заказчик;
	Движение.Задача = Ссылка;
	Движение.ЧасыФактические = Работы.Итог("Трудозатраты");
